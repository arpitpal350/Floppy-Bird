...
class ObstaclePair extends PositionComponent {
  ...
  void _drawPillar(
    ...
    final pillarRect = Rect.fromLTWH(
      0,
      y,
      size.x,
      height,
    ...
    canvas.drawRRect(
      ...
      Paint()..color = const Color(0xff7655d7),
    );
    ...
    // Pillar cap
    final capY = fromBottom ? y : y + height - 16;
    ...
    canvas.drawRRect(
      ...
      Paint()..color = const Color(0xff9a7af0),
    );
  }
}
